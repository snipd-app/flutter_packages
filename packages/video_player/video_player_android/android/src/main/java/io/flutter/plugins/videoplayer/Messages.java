...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class PlattformVideoPlaybackOptions {
    private @Nullable Long playbackEndTimeMs;

    public @Nullable Long getPlaybackEndTimeMs() {
      return playbackEndTimeMs;
    }

    public void setPlaybackEndTimeMs(@Nullable Long setterArg) {
      this.playbackEndTimeMs = setterArg;
    }

    private @NonNull Long maxBufferDurationSeconds;

    public @NonNull Long getMaxBufferDurationSeconds() {
      return maxBufferDurationSeconds;
    }

    public void setMaxBufferDurationSeconds(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"maxBufferDurationSeconds\" is null.");
      }
      this.maxBufferDurationSeconds = setterArg;
    }
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      PlattformVideoPlaybackOptions that = (PlattformVideoPlaybackOptions) o;
      return Objects.equals(playbackEndTimeMs, that.playbackEndTimeMs) && maxBufferDurationSeconds.equals(that.maxBufferDurationSeconds);
    }

    @Override
    public int hashCode() {
      return Objects.hash(playbackEndTimeMs, maxBufferDurationSeconds);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setPlaybackEndTimeMs(@Nullable Long setterArg) {
        this.playbackEndTimeMs = setterArg;
        return this;
      }

      private @Nullable Long maxBufferDurationSeconds;

      @CanIgnoreReturnValue
      public @NonNull Builder setMaxBufferDurationSeconds(@NonNull Long setterArg) {
        this.maxBufferDurationSeconds = setterArg;
        return this;
      }

      public @NonNull PlattformVideoPlaybackOptions build() {
        PlattformVideoPlaybackOptions pigeonReturn = new PlattformVideoPlaybackOptions();
        pigeonReturn.setPlaybackEndTimeMs(playbackEndTimeMs);
        pigeonReturn.setMaxBufferDurationSeconds(maxBufferDurationSeconds);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(playbackEndTimeMs);
      toListResult.add(maxBufferDurationSeconds);
      return toListResult;
    }

    static @NonNull PlattformVideoPlaybackOptions fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      PlattformVideoPlaybackOptions pigeonResult = new PlattformVideoPlaybackOptions();
      Object playbackEndTimeMs = pigeonVar_list.get(0);
      pigeonResult.setPlaybackEndTimeMs((Long) playbackEndTimeMs);
      Object maxBufferDurationSeconds = pigeonVar_list.get(1);
      pigeonResult.setMaxBufferDurationSeconds((Long) maxBufferDurationSeconds);
      return pigeonResult;
    }
  }
  ...
  public static final class CreateMessage {
    ...
    private @NonNull PlattformVideoPlaybackOptions playbackOptions;

    public @NonNull PlattformVideoPlaybackOptions getPlaybackOptions() {
      return playbackOptions;
    }

    public void setPlaybackOptions(@NonNull PlattformVideoPlaybackOptions setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"playbackOptions\" is null.");
      }
      this.playbackOptions = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(asset, that.asset) && Objects.equals(uri, that.uri) && Objects.equals(packageName, that.packageName) && Objects.equals(formatHint, that.formatHint) && httpHeaders.equals(that.httpHeaders) && Objects.equals(viewType, that.viewType) && Objects.equals(playbackEndTimeMs, that.playbackEndTimeMs) && playbackOptions.equals(that.playbackOptions);
    }

    @Override
    public int hashCode() {
      return Objects.hash(asset, uri, packageName, formatHint, httpHeaders, viewType, playbackEndTimeMs, playbackOptions);
    }
    ...
    public static final class Builder {
      ...
      private @Nullable PlattformVideoPlaybackOptions playbackOptions;

      @CanIgnoreReturnValue
      public @NonNull Builder setPlaybackOptions(@NonNull PlattformVideoPlaybackOptions setterArg) {
        this.playbackOptions = setterArg;
        return this;
      }
      ...
      public @NonNull CreateMessage build() {
        ...
        pigeonReturn.setPlaybackEndTimeMs(playbackEndTimeMs);
        pigeonReturn.setPlaybackOptions(playbackOptions);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(playbackEndTimeMs);
      toListResult.add(playbackOptions);
      return toListResult;
    }
    ...
    static @NonNull CreateMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object playbackEndTimeMs = pigeonVar_list.get(6);
      pigeonResult.setPlaybackEndTimeMs((Long) playbackEndTimeMs);
      Object playbackOptions = pigeonVar_list.get(7);
      pigeonResult.setPlaybackOptions((PlattformVideoPlaybackOptions) playbackOptions);
      return pigeonResult;
    }
  }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 131:
          return PlattformVideoPlaybackOptions.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 132:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PlattformVideoPlaybackOptions) {
        stream.write(131);
        writeValue(stream, ((PlattformVideoPlaybackOptions) value).toList());
  ...
  public interface AndroidVideoPlayerApi {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setMaxBufferDuration" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
